...
public class QuestOWLExample {
	...
	private static final String OWLFILE = "src/test/resources/bigdataplatform.owl";
	private static final String OBDAFILE = "src/test/resources/bigdataplatform.obda";
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("PRINTING 5 RESULTS:");
		for (List<String> tuple : result) {
			System.out.println(tuple);
		}

		System.out.println("PRINTING SIGNATURE:");
